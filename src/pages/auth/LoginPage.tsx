...
export const LoginPage: React.FC<LoginPageProps> = ({ onNavigate }) => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      await loginWithGoogle('customer.google@gmail.com', 'Ayesha Malik');
      toast.success('Google Connected', 'Successfully signed in with your Google account.');
      onNavigate('/account');
    } catch (err: any) {
      toast.error('Google Sign In Failed', err.message || 'Unable to connect with Google.');
    } finally {
